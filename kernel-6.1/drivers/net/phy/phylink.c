...
#define YT8512C_PHY_ID 0x00000128
	...
	if (pl->phydev->phy_id == YT8512C_PHY_ID) {
		phy_write(pl->phydev, 0x1e, 0x40c0);
		phy_write(pl->phydev, 0x1f, 0x130);

		phy_write(pl->phydev, 0x1e, 0x40c3);
		phy_write(pl->phydev, 0x1f, 0x30);
	}
